...
public class CameraSource {
     ...
     * surface texture is used for the preview so frames can be displayed to the user.
     *
     * @param surfaceTexture the surface holder to use for the preview frames
     * @throws IOException if the supplied surface texture could not be used as the preview display
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public CameraSource start(SurfaceTexture surfaceTexture) throws IOException{
        synchronized (this.mCameraLock){
            ...
            mProcessingThread = new Thread(this.mFrameProcessor);
            mFrameProcessor.setActive(true);
            mProcessingThread.start();
        }
        return this;
